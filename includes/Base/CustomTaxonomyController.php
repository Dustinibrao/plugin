...
class CustomTaxonomyController extends BaseController
{
    ...
    public function setSettings() {
        $args = array(
            array(
                "option_group" => "dustin_plugin_tax_settings",
                "option_name" => "dustin_plugin_tax",
    ...
    public function storeCustomTaxonomies() {
        ...
        $options = get_option("dustin_plugin_tax") ?: array();
