...
class TaxonomyCallbacks
{
	...
	{
		$output = get_option("dustin_plugin_tax");
    ...
    public function textField( $args )
	{
		...
		// Pre populate text when you click edit cpt
    ...
    public function checkboxField( $args )
	{
		...
		// Check to see if public and archive are set to true
		if(isset($_POST["edit_taxonomy"])) {
	...
	public function checkboxPostTypesField( $args )
	{
		...
		// show only post types that user has access to
