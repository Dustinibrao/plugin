...
class MediaWidget extends WP_Widget
{
    ...
    {
        $this-> widget_ID = "dustin_media_widget";
        $this-> widget_name = "Dustin Media Widget";
    ...
    // form()
    public function form($insance) {
        $title = !empty($insance["title"]) ? $insance["title"] : esc_html__("Custom Text","awps" );
        $image = !empty($insance["image"]) ? $insance["image"] : "";
        ?>
        <p>
