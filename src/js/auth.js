document.addEventListener("DOMContentLoaded", function (e) {
	const showAuthBtn = document.getElementById("dustin-show-auth-form"),
		authContainer = document.getElementById("dustin-auth-container"),
		close = document.getElementById("dustin-auth-close"),
		authForm = document.getElementById("dustin-auth-form"),
	...
	authForm.addEventListener("submit", (e) => {
		...
		let data = {
			...
			nonce: authForm.querySelector('[name="dustin_auth"]').value,
		};
        // validate everything
